...
class ResponsablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsable" do
    assert_difference('Responsable.count') do
      post responsables_url, params: { responsable: { apellidos: @responsable.apellidos, belongs_to: @responsable.belongs_to, cargo: @responsable.cargo, nif: @responsable.nif, nombre: @responsable.nombre } }
    end
  ...
  test "should update responsable" do
    patch responsable_url(@responsable), params: { responsable: { apellidos: @responsable.apellidos, belongs_to: @responsable.belongs_to, cargo: @responsable.cargo, nif: @responsable.nif, nombre: @responsable.nombre } }
